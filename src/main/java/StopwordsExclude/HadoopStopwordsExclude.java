...
public class HadoopStopwordsExclude {

    public static void main(String[] args) throws Exception {
        Job job = Job.getInstance(new Configuration());
        job.setJarByClass(HadoopStopwordsExclude.class);
    ...
    private static class Reduce extends Reducer<Text,IntWritable, Text, IntWritable>{
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            ...
            /*try {
                BufferedReader br = new BufferedReader(new FileReader("hdfs://bigdata01.ad.nith.no/users/vedole10/stopWord.txt"));
            ...
            try{
                Path pt=new Path("hdfs://bigdata01.ad.nith.no/user/vedole10/stopWords.txt");
        ...
        protected void reduce(Text key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException {
            ...
            for (String stopWord : stopWords){
                if(key.toString().equals(stopWord)) {
                    return;
                }
            }
